...
assert.ok(app.includes("function budgetIssueTable"));
assert.ok(app.includes('fieldShell("Trip Style", select("trip.budget.style"'));
assert.ok(app.includes("totalBudgetOptions"));
