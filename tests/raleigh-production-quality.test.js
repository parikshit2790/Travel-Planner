...
function raleighProviderFixture() {
  ...
  const places = [
    ...
    place("jubala", "Jubala Coffee", "raleigh-core", "Breakfast and coffee option that fits Raleigh museum mornings.", ["cafe", "restaurant"], ["breakfast", "coffee", "lunch"], 78, 50, 9, 22, 35.8050, -78.6500),
    place("morning-times", "The Morning Times", "raleigh-core", "Downtown Raleigh coffee, breakfast, and light lunch stop.", ["cafe", "restaurant"], ["breakfast", "coffee", "lunch"], 79, 50, 8, 24, 35.7786, -78.6386),
    place("big-ed", "Big Ed's City Market", "raleigh-core", "Classic Raleigh breakfast and Southern lunch option near City Market.", ["restaurant", "breakfast"], ["breakfast", "brunch", "lunch"], 80, 60, 12, 28, 35.7763, -78.6367),
    place("rosewater", "Rosewater Kitchen and Bar", "raleigh-parks", "North Hills restaurant for dinner after Raleigh west-side parks or museum time.", ["restaurant"], ["dinner", "lunch", "vegetarian"], 77, 75, 18, 50, 35.8384, -78.6423),
    place("poole", "Poole's Diner", "raleigh-core", "Downtown Raleigh dinner restaurant with reservation-worthy local identity.", ["restaurant"], ["dinner", "local dining"], 83, 90, 22, 60, 35.7766, -78.6476),
    place("m-sushi", "M Sushi Durham", "durham-triangle", "Durham dinner option for a Triangle day around Duke and downtown Durham.", ["restaurant"], ["lunch", "dinner", "Durham"], 81, 80, 25, 70, 35.9968, -78.9020),
    place("acme", "Acme Food and Beverage Co.", "chapel-hill", "Carrboro restaurant that fits a Chapel Hill and Carrboro day.", ["restaurant"], ["lunch", "dinner", "Carrboro"], 80, 80, 18, 55, 35.9101, -79.0734),
