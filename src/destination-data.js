...
export const destinationProfiles = [
  ...
  },
  {
    ...
    places: [
      ...
      place("uptown-breakfast-brunch", "Uptown breakfast and brunch candidates", "uptown", "Use actual nearby cafes or brunch restaurants as the verified morning meal set before museums or departure.", ["breakfast", "brunch", "cafe", "food"], ["Cafes", "Bakeries", "Vegetarian-friendly"], 60, 12, 30, "indoor", "low", "good", ["solo", "couple", "family", "senior"], "morning", 74),
    ...
    foodAreas: [
      foodArea("uptown-food", "Uptown verified dining candidates", "uptown", ["American", "Italian", "Local cuisine", "Cafes", "Casual dining"], ["breakfast", "lunch", "dinner"], ["budget", "moderate", "premium"], ["Vegetarian", "Gluten-free", "Avoid pork"], ["quiet", "lively"]),
      foodArea("south-end-food", "South End dinner candidates", "south-end", ["American", "Mexican", "Italian", "Cafes", "Casual dining"], ["lunch", "dinner"], ["moderate"], ["Vegetarian", "Vegan", "Gluten-free"], ["nightlife", "live-music"]),
      foodArea("noda-food", "NoDa cafe and dinner candidates", "noda", ["American", "Mexican", "Cafes", "Bakeries", "Vegetarian-friendly"], ["breakfast", "lunch", "dinner"], ["budget", "moderate"], ["Vegetarian", "Vegan"], ["live-music", "lively"]),
