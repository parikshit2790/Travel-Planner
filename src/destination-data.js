...
const staticDestinationProfiles = [
  ...
  },
  {
    ...
    regions: [
      ...
      region("crowders-mountain", "Crowders Mountain", "Closest serious mountain hiking and viewpoint day trip west of Charlotte, with clear route-burden planning.", 35.2136, -81.2934, ["mountain", "hiking", "day-trip", "viewpoint"], ["uptown", "lake-wylie"]),
      region("lake-wylie", "Lake Wylie and Ebenezer Park", "Nearby lake, park, picnic, kayaking, waterfront, and lower-intensity outdoor option southwest of Charlotte.", 35.1085, -81.0487, ["lake", "water", "park", "relaxation"], ["uptown", "crowders-mountain", "carowinds"]),
      ...
      region("ballantyne", "Ballantyne and south Charlotte dining", "Polished south Charlotte dining, The Bowl at Ballantyne, easier parking, and relaxed evening alternatives.", 35.0563, -80.8528, ["food", "dining", "relaxed", "evening"], ["south-end", "carowinds"]),
      region("chimney-rock-lake-lure", "Chimney Rock and Lake Lure", "High-value mountain-and-lake regional day trip, memorable but drive-heavy from Charlotte.", 35.4329, -82.2504, ["mountain", "lake", "scenic", "long-day-trip"], ["asheville-blue-ridge"]),
      region("south-mountains", "South Mountains State Park", "Waterfall and foothills hiking day trip west of Charlotte; useful for nature-focused travelers.", 35.5965, -81.6465, ["waterfall", "hiking", "state-park", "day-trip"], ["crowders-mountain"]),
      region("asheville-blue-ridge", "Asheville and Blue Ridge Parkway", "Regional extension with Asheville, Blue Ridge Parkway scenery, Biltmore context, food, and mountain variety.", 35.5951, -82.5515, ["regional", "mountains", "parkway", "overnight"], ["chimney-rock-lake-lure"]),
      region("boone-blowing-rock", "Boone, Blowing Rock, and Grandfather Mountain", "Long mountain extension with Blue Ridge towns, overlooks, hiking, and Grandfather Mountain when route limits support it.", 36.1351, -81.6776, ["regional", "mountain", "overnight", "scenic"], ["asheville-blue-ridge"])
    ],
    places: [
      ...
      place("crowders-mountain-state-park", "Crowders Mountain State Park", "crowders-mountain", "Closest serious mountain-view outing from Charlotte; evaluate hiking comfort and summer heat before selecting.", ["mountain", "hiking", "day-trip", "nature"], ["Outdoor Activities", "Nature", "Scenic drives", "Photography"], 210, 0, 10, "outdoor", "high", "limited", ["solo", "couple", "family"], "morning", 88),
      place("lake-wylie-ebenezer-park", "Lake Wylie and Ebenezer Park", "lake-wylie", "Lake, picnic, shoreline, paddle-style options, and calmer waterfront time close enough for a lighter nature day.", ["lake", "water", "park", "relaxation"], ["Water Experiences", "Nature", "Relaxation", "Easy outdoor walks"], 150, 0, 25, "outdoor", "high", "moderate", ["solo", "couple", "family", "senior"], "afternoon", 82),
      place("bowl-at-ballantyne", "The Bowl at Ballantyne", "ballantyne", "South Charlotte dining and entertainment district useful for a polished, lower-friction dinner or relaxed evening.", ["food", "dining", "evening", "local-neighborhood"], ["Local cuisine", "Casual dining", "Dessert or cafe evenings"], 95, 15, 60, "mixed", "low", "good", ["solo", "couple", "family", "senior"], "evening", 78),
      place("fahrenheit-charlotte", "Fahrenheit Charlotte", "uptown", "Rooftop skyline dinner candidate for a memorable Charlotte evening; confirm reservations, prices, and dietary fit.", ["food", "rooftop", "dinner", "skyline"], ["Fine dining", "Sunset activities", "Photography", "Local cuisine"], 100, 35, 90, "indoor", "low", "good", ["solo", "couple"], "dinner", 84),
      place("amelies-french-bakery", "Amelie's French Bakery & Cafe", "uptown", "Cafe and bakery-style breakfast or dessert stop with flexible vegetarian-friendly choices; verify current hours before relying on it.", ["breakfast", "brunch", "cafe", "bakery", "food"], ["Cafes", "Bakeries", "Desserts", "Vegetarian-friendly"], 60, 10, 28, "indoor", "low", "good", ["solo", "couple", "family", "senior"], "morning", 80),
      place("rhino-market-deli", "Rhino Market & Deli", "uptown", "Casual market and deli option for breakfast, sandwiches, snacks, or an easy route-fit meal.", ["breakfast", "lunch", "cafe", "deli", "food"], ["Cafes", "Casual dining", "Packed lunch acceptable"], 55, 10, 25, "indoor", "low", "good", ["solo", "couple", "family", "senior"], "morning", 76),
      place("easy-like-sunday", "Easy Like Sunday", "south-end", "Brunch-focused restaurant useful for a slower Charlotte morning near South End; confirm wait times and reservations.", ["breakfast", "brunch", "restaurant", "food"], ["Cafes", "Casual dining", "Vegetarian-friendly"], 70, 14, 34, "indoor", "low", "good", ["solo", "couple", "family"], "morning", 78),
      place("haberdish", "Haberdish", "noda", "NoDa restaurant candidate for a local-feeling lunch or dinner around the arts district; verify vegetarian and allergy fit directly.", ["restaurant", "lunch", "dinner", "food"], ["Local cuisine", "Casual dining", "Vegetarian-friendly"], 85, 18, 55, "indoor", "low", "good", ["solo", "couple", "family"], "dinner", 82),
      place("supperland", "Supperland", "plaza-midwood", "Plaza Midwood dinner candidate for a polished couple-friendly evening; check reservations and menu fit before booking.", ["restaurant", "dinner", "food", "fine-dining"], ["Fine dining", "Local cuisine", "Dessert or cafe evenings"], 100, 30, 85, "indoor", "low", "good", ["solo", "couple"], "dinner", 82),
      place("flower-child-charlotte", "Flower Child Charlotte", "south-end", "Vegetarian-friendly lunch or casual dinner candidate that can fit lighter meals near South End.", ["restaurant", "lunch", "dinner", "food"], ["Vegetarian", "Vegan", "Casual dining", "Gluten-free"], 65, 14, 32, "indoor", "low", "good", ["solo", "couple", "family", "senior"], "lunch", 77),
      place("uptown-breakfast-brunch", "Uptown breakfast and brunch candidates", "uptown", "Use actual nearby cafes or brunch restaurants as a backup morning meal set before museums or departure.", ["breakfast", "brunch", "cafe", "food"], ["Cafes", "Bakeries", "Vegetarian-friendly"], 60, 12, 30, "indoor", "low", "good", ["solo", "couple", "family", "senior"], "morning", 62),
      place("south-end-dinner-breweries", "South End dinner and brewery corridor", "south-end", "Walkable dinner, dessert, drinks-optional, and brewery corridor with light-rail access and many casual local choices.", ["food", "brewery", "evening", "dinner"], ["Casual dining", "Bars", "Breweries", "Nightlife"], 120, 20, 65, "mixed", "low", "good", ["solo", "couple"], "evening", 82),
      place("chimney-rock-lake-lure", "Chimney Rock and Lake Lure day trip", "chimney-rock-lake-lure", "Memorable mountain views and lake scenery from Charlotte, but the round trip is long enough to require explicit route approval.", ["mountain", "lake", "scenic-drive", "long-day-trip"], ["Nature", "Scenic drives", "Water Experiences", "Photography"], 360, 15, 45, "outdoor", "high", "limited", ["solo", "couple", "family"], "morning", 90),
      place("south-mountains-state-park", "South Mountains State Park", "south-mountains", "Waterfall and foothills state-park option for nature-focused trips; stronger for hikers than minimal-walking groups.", ["waterfall", "hiking", "state-park", "nature"], ["Outdoor Activities", "Nature", "Waterfalls", "Photography"], 300, 0, 10, "outdoor", "high", "limited", ["solo", "couple", "family"], "morning", 84),
      place("blue-ridge-parkway-asheville", "Asheville and Blue Ridge Parkway extension", "asheville-blue-ridge", "Higher-variety regional extension for mountains, food, Biltmore-area context, and Blue Ridge Parkway overlooks; better with a split stay.", ["regional", "scenic-drive", "mountain", "overnight"], ["Scenic drives", "Nature", "Local cuisine", "Photography"], 480, 20, 120, "mixed", "high", "moderate", ["solo", "couple", "family"], "full-day", 88),
      place("boone-blowing-rock-grandfather", "Boone, Blowing Rock, and Grandfather Mountain extension", "boone-blowing-rock", "Long Blue Ridge mountain option with towns and major viewpoints; not an easy Charlotte day trip unless route limits are intentionally expanded.", ["regional", "mountain", "scenic-drive", "overnight"], ["Scenic drives", "Outdoor Activities", "Photography"], 480, 15, 100, "outdoor", "high", "limited", ["solo", "couple", "family"], "full-day", 82),
    ...
    foodAreas: [
      foodArea("uptown-food", "Uptown dining guide", "uptown", ["American", "Italian", "Local cuisine", "Cafes", "Casual dining"], ["breakfast", "lunch", "dinner"], ["budget", "moderate", "premium"], ["Vegetarian", "Gluten-free", "Avoid pork"], ["quiet", "lively"]),
      foodArea("south-end-food", "South End dining guide", "south-end", ["American", "Mexican", "Italian", "Cafes", "Casual dining"], ["lunch", "dinner"], ["moderate"], ["Vegetarian", "Vegan", "Gluten-free"], ["nightlife", "live-music"]),
      foodArea("noda-food", "NoDa cafe and dining guide", "noda", ["American", "Mexican", "Cafes", "Bakeries", "Vegetarian-friendly"], ["breakfast", "lunch", "dinner"], ["budget", "moderate"], ["Vegetarian", "Vegan"], ["live-music", "lively"]),
      ...
      foodArea("fahrenheit-rooftop-food", "Fahrenheit Charlotte rooftop dinner", "uptown", ["American", "Fine dining", "Vegetarian-friendly", "Cocktails"], ["dinner"], ["premium"], ["Vegetarian", "Gluten-free"], ["sunset", "quiet"]),
      foodArea("ballantyne-bowl-food", "The Bowl at Ballantyne dining", "ballantyne", ["American", "Casual dining", "Desserts", "Cafes"], ["lunch", "dinner"], ["moderate"], ["Vegetarian", "Gluten-free"], ["quiet"]),
      foodArea("lake-wylie-food", "Lake Wylie casual waterfront food", "lake-wylie", ["American", "Cafes", "Casual dining"], ["lunch"], ["budget", "moderate"], ["Vegetarian"], ["quiet", "sunset"])
    ],
    scenicRoutes: [
      ...
      route("charlotte-crowders", "Charlotte to Crowders Mountain", "uptown", "crowders-mountain", 45, 32, ["mountain", "hiking", "day-trip"], "morning", "Use as the closest serious mountain option; keep afternoon light in summer."),
      route("charlotte-lake-wylie", "Charlotte to Lake Wylie and Ebenezer Park", "uptown", "lake-wylie", 35, 22, ["lake", "water", "nearby"], "afternoon", "Useful for a lower-intensity lake plan without changing hotels."),
      ...
      ,
      route("charlotte-ballantyne", "Charlotte to Ballantyne dining", "uptown", "ballantyne", 25, 16, ["food", "evening"], "evening", "Good lower-friction dinner alternative when South End or Uptown is too busy."),
      route("charlotte-chimney-lake-lure", "Charlotte to Chimney Rock and Lake Lure", "uptown", "chimney-rock-lake-lure", 125, 95, ["mountain", "lake", "long-day-trip"], "morning", "Memorable but tiring as a day trip; consider an overnight if adding Asheville."),
      route("charlotte-south-mountains", "Charlotte to South Mountains State Park", "uptown", "south-mountains", 95, 70, ["waterfall", "hiking", "day-trip"], "morning", "Nature-focused option that needs hiking comfort and daylight planning."),
      route("charlotte-asheville-blue-ridge", "Charlotte to Asheville and Blue Ridge Parkway", "uptown", "asheville-blue-ridge", 130, 130, ["regional", "mountains", "overnight"], "morning", "Better as a split-stay or intentional long regional day."),
      route("charlotte-boone-grandfather", "Charlotte to Boone, Blowing Rock, and Grandfather Mountain", "uptown", "boone-blowing-rock", 125, 100, ["regional", "mountain", "overnight"], "morning", "Treat as an overnight-style mountain extension unless the user accepts a long driving day.")
    ]
  },
  {
    id: "dallas",
...
function normalizeGeneratedDestinationProfile(profile) {
  ...
  return {
    ...
    scenicRoutes: scenicRoutes.map((item) => ({
      ...
      recommendedStops: arrayOfStrings(item.recommendedStops, 12),
      overlooks: arrayOfStrings(item.overlooks, 10),
      hikes: arrayOfStrings(item.hikes, 10),
      waterfalls: arrayOfStrings(item.waterfalls, 10),
      parking: String(item.parking || ""),
      seasonalClosures: arrayOfStrings(item.seasonalClosures, 6),
      daylightRequired: Boolean(item.daylightRequired),
      offlineMapRecommended: Boolean(item.offlineMapRecommended),
      fullExperienceDurationMinutes: Number(item.fullExperienceDurationMinutes || item.estimatedDriveMinutes || 20)
    })),
    scenicCorridors: Array.isArray(profile.scenicCorridors) ? profile.scenicCorridors.map((item) => ({
      id: String(item.id || ""),
      name: String(item.name || ""),
      start: String(item.start || ""),
      end: String(item.end || ""),
      originRegionId: String(item.originRegionId || ""),
      destinationRegionId: String(item.destinationRegionId || ""),
      routeDistanceMiles: Number(item.routeDistanceMiles || item.estimatedDistanceMiles || 0),
      routeDurationMinutes: Number(item.routeDurationMinutes || item.estimatedDriveMinutes || 0),
      recommendedStops: arrayOfStrings(item.recommendedStops, 14),
      overlooks: arrayOfStrings(item.overlooks, 12),
      hikes: arrayOfStrings(item.hikes, 12),
      waterfalls: arrayOfStrings(item.waterfalls, 12),
      parking: String(item.parking || ""),
      seasonalClosures: arrayOfStrings(item.seasonalClosures, 8),
      daylightRequired: Boolean(item.daylightRequired),
      offlineMapRecommended: Boolean(item.offlineMapRecommended),
      fullExperienceDurationMinutes: Number(item.fullExperienceDurationMinutes || item.routeDurationMinutes || 0),
      sourceMetadata: item.sourceMetadata || profile.sourceMetadata || {}
    })).filter((item) => item.id && item.name).slice(0, 14) : [],
    hikesAndWaterfalls: Array.isArray(profile.hikesAndWaterfalls) ? profile.hikesAndWaterfalls.map((item) => ({
      id: String(item.id || ""),
      trailName: String(item.trailName || item.name || ""),
      trailhead: String(item.trailhead || ""),
      regionId: String(item.regionId || ""),
      coordinates: item.coordinates || null,
      parking: String(item.parking || ""),
      roundTripDistanceMiles: Number(item.roundTripDistanceMiles || 0),
      elevationGainFeet: Number(item.elevationGainFeet || 0),
      estimatedDurationMinutes: Number(item.estimatedDurationMinutes || 0),
      difficulty: String(item.difficulty || ""),
      terrain: String(item.terrain || ""),
      waterfallOrViewpoint: String(item.waterfallOrViewpoint || ""),
      crowdLevel: String(item.crowdLevel || ""),
      earlyStartRecommended: Boolean(item.earlyStartRecommended),
      seasonalCondition: String(item.seasonalCondition || ""),
      weatherSensitivity: String(item.weatherSensitivity || ""),
      travelerFit: String(item.travelerFit || ""),
      backupOption: String(item.backupOption || ""),
      sourceConfidence: String(item.sourceConfidence || item.sourceMetadata?.dataConfidence || "medium"),
      sourceMetadata: item.sourceMetadata || profile.sourceMetadata || {}
    })).filter((item) => item.id && item.trailName).slice(0, 20) : [],
    regionalDestinationProfile: profile.regionalDestinationProfile || profile.regionalProfile || null,
