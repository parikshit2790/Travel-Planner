...
export function createSampleLosAngelesTrip(today = new Date()) {
  ...
  sample.routePreferences.tripStructure = "recommend";
  sample.routePreferences.openToNearbyCities = "Yes";
  sample.routePreferences.maxHotelChanges = "1";
  sample.routePreferences.maxTransferDriveTime = "3 hours";
  sample.routePreferences.maxDayTripDriveTime = "2 hours";
  sample.routePreferences.placesInMind = "Santa Monica, Venice, Malibu, San Diego, Santa Barbara";
  sample.routePreferences.mustDoPlaces = "Beaches, scenic viewpoints, vegetarian-friendly food";
  sample.routePreferences.rentalCar = "Yes";
